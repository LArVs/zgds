...
$eSchool->modx->regClientCSS( $eSchool->config[ 'url' ][ 'js' ] . 'ExtJS-v.3.2.1/ux/css/ux-all.css' );
...
//$eSchool->regClientStartupScript( 'ExtJS-v.3.2.1/ux/js/ux-all.js' );
$eSchool->regClientStartupScript( 'ExtJS-v.3.2.1/ux/js/ux-all-debug.js' );
...
$eSchool->regClientStartupScript( 'learner.js' );
