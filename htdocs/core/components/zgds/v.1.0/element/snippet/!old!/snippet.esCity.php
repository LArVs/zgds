...
// load .css
//$eSchool->modx->regClientCSS( $eSchool->config[ 'url' ][ 'js' ] . 'ExtJS-v.3.2.1/resources/css/ext-all.css' );
$eSchool->modx->regClientCSS( $eSchool->config[ 'url' ][ 'js' ] . 'ExtJS-v.3.2.1/resources/css/ext-all-notheme.css' );
//$eSchool->modx->regClientCSS( $eSchool->config[ 'url' ][ 'js' ] . 'ExtJS-v.3.2.1/resources/css/xtheme-gray.css' );
...
$eSchool->regClientStartupScript( 'city.js' );
